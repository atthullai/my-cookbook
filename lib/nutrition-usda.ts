...
const QUERY_ALIASES: Array<[RegExp, string]> = [
  ...
  [/\bchilli?\b|\bchilies\b|\bchillies\b/i, "chili pepper"],
...
const LOCAL_FOOD_FALLBACKS: Array<{ pattern: RegExp; food: FoodSearchResult }> = [
  ...
  localFood(/\bchilli?\b|\bchilies\b|\bchillies\b/i, "Chili pepper, raw", { calories_kcal: 40, fat_g: 0.4, carbs_g: 8.8, fiber_g: 1.5, sugar_g: 5.3, protein_g: 1.9, calcium_mg: 18, iron_mg: 1.0, magnesium_mg: 25, phosphorus_mg: 46, potassium_mg: 340, zinc_mg: 0.3, vitamin_a_mcg: 59, vitamin_c_mg: 144, vitamin_b6_mg: 0.5, folate_mcg: 23 }),
